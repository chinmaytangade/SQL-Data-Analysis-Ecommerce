...
(1, 'Chinmay Tangade', 'chinmay@example.com', 'Mumbai', 'India'),
(2, 'Raj Shinde', 'raj@example.com', 'Delhi', 'India'),
(3, 'Prajwal Shelar', 'prajwal@example.com', 'New York', 'USA'),
(4, 'Tanmay', 'tanmay@example.com', 'Bangalore', 'India'),
(5, 'Chetan Biradar', 'chetya@example.com', 'London', 'UK');
